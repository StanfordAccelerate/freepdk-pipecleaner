...
//	
//
//  Source file: /horowitz/users/ajcars/garnet/pe_core/genesis/test_pe.svp
...
//
// use_add (_GENESIS2_CMD_LINE_PRIORITY_) = 2
//
// use_cntr (_GENESIS2_CMD_LINE_PRIORITY_) = 1
//
// use_bool (_GENESIS2_CMD_LINE_PRIORITY_) = 1
//
// use_shift (_GENESIS2_CMD_LINE_PRIORITY_) = 1
//
// mult_mode (_GENESIS2_CMD_LINE_PRIORITY_) = 2
//
...
logic  [16-1:0]        op_a;
logic  [16-1:0]        op_a_reg;
logic  [16-1:0]        op_b;
logic  [16-1:0]        op_b_reg;
logic  [16-1:0]        op_c;
logic  [16-1:0]        op_c_reg;
logic                         op_d_p;
logic                         op_d_p_reg;
logic                         op_e_p;
logic                         op_e_p_reg;
...
logic                 op_b_ld;
logic [16-1:0] op_b_val;

logic en_acc;
assign en_acc = op_code[9:9];

  logic cntr_en;
  //logic [16-1:0] cntr_next;
  ...
  assign op_b_val = (cfg_en && (cfg_a == 8'hF1)) ?
                    cfg_d[16-1:0] :
                    ((cntr_en & comp_res_p)|(en_acc & op_d_p) ? {16{1'b0}}: comp_res);
...
test_opt_reg #(.DataWidth(16)) test_opt_reg_c
(
  .clk        (clk),
  .clk_en     (clk_en),
  .rst_n      (rst_n),
